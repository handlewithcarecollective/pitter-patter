...
import { getPresenceColor as defaultGetPresenceColor } from "./decorations/getPresenceColor.ts";
...
export function createPresence(
  createWidget: (pos: number, indicator: PresenceIndicator) => Decoration,
) {
      ...
      state: {
        ...
        apply(tr, { decorations, indicators }, _oldState, editorState) {
          ...
          for (const clientIndicators of Object.values(nextIndicators)) {
            ...
            nextDecorations.push(createWidget(anchor, indicator));
          }
