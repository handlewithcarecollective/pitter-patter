...
[throughput](https://github.com/stepwisehq/prosemirror-collab-commit#prosemirror-collab-commit) and
[fairness](https://github.com/stepwisehq/prosemirror-collab-commit#prosemirror-collab-commit) over
the default implementation. It uses ProseMirror steps as the unit of change, just like
